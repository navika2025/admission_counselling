...
from django.shortcuts import render
from courses.models import CoursesPage, Course, TopCollege
from common.models import Page
...
def courses(request):
    ...
    courses_page = CoursesPage.objects.prefetch_related(
        "guidance_section",
        "exam_categories__courses",
        "exam_categories__top_colleges"
    ).first()
    ...
    exam_categories = courses_page.exam_categories.all() if courses_page else []
    guidance = courses_page.guidance_section.all() if courses_page else []
